# Universal Subagent & Role Recommendations

Subagents (and Specialized Role Prompts) are focused Agent instances or personas that run independently or in parallel to perform code reviews, security audits, performance analysis, or specialized code generation.

**Implementation Locations by Agent Platform:**
- **Claude Code**: `.claude/agents/<agent-name>.md`
- **Antigravity (Gemini)**: `.gemini/config/plugins/.../agents/<agent-name>.md` or subagent declarations
- **Codex**: Specialized role system prompts or subagent task profiles in `AGENTS.md`
