# Universal Hooks & Guardrails Recommendations

Hooks and Guardrails automatically run commands or intercept tool executions in response to Agent actions (formatting, linting, blocking dangerous edits, running tests).

**Implementation by Agent Platform:**
- **Claude Code**: PreToolUse and PostToolUse hooks in `.claude/settings.json`.
