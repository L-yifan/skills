# Agent Instruction Files (AGENTS.md / CLAUDE.md) Update Guidelines

## Core Principle

Only add information that will genuinely help future AI agent sessions. The context window is precious - every line must earn its place.
...
- [ ] Would a new AI agent session find this helpful?
