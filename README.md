...
| 技能名 | 描述 | 安装命令 |
|--------|------|----------|
| html-artifacts-plus | 生成自包含 HTML 制品，按内容形状选择对比、时间线、投屏、数据视图或编辑器；包含构图闭环、有界双视口验收与文档绑定 patch 导出 | `npx skills add https://github.com/L-yifan/skills --skill html-artifacts-plus` |
